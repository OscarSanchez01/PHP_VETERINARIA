...
<body class="bg-indigo-200">
    ...
    <div class="bg-indigo-500 m-2 rounded-sm p-4 mb-10">
        ...
        <form method="GET">
            ...
            <a href="servicios_realizados.php"><button type="button" class="bg-indigo-900 rounded-sm p-2 text-white">Quitar Filtro</button></a>
        </form>
    ...
    <div class="bg-indigo-500 m-2 rounded-sm p-4 mb-10">
        ...
        <form method="POST" class="flex gap-5">
            ...
            <label class="text-white  text-center">Cod_Servicio <input class="bg-white rounded-sm text-rose-400 p-2 font-medium border-rose-600 placeholder:text-indigo-300 focus:outline-none focus:border-b-4 focus:rounded-b-lg" type="text" name="Cod_Servicio" value="<?= $editando ? $servicioEditar['Cod_Servicio'] : "" ?>" required></label>
            <label class="text-white  text-center">ID_Perro <input class="bg-white rounded-sm text-rose-400 p-2 font-medium border-rose-600 placeholder:text-indigo-300 focus:outline-none focus:border-b-4 focus:rounded-b-lg" type="number" name="ID_Perro" value="<?= $editando ? $servicioEditar['ID_Perro'] : "" ?>" required></label>
            <label class="text-white text-center">Fecha <input class="bg-white rounded-sm text-rose-400 p-2 font-medium border-rose-600 placeholder:text-indigo-300 focus:outline-none focus:border-b-4 focus:rounded-b-lg" type="date" name="Fecha" value="<?= $editando ? $servicioEditar['Fecha'] : "" ?>" required></label>
            ...
            <label class="text-white  text-center">Precio_Final <input class="bg-white rounded-sm text-rose-400 p-2 font-medium border-rose-600 placeholder:text-indigo-300 focus:outline-none focus:border-b-4 focus:rounded-b-lg" type="number" step="0.01" name="Precio_Final" value="<?= $editando ? $servicioEditar['Precio_Final'] : "" ?>" required></label>
            <label class="text-white  text-center">Dni <input class="bg-white rounded-sm text-rose-400 p-2 font-medium border-rose-600 placeholder:text-indigo-300 focus:outline-none focus:border-b-4 focus:rounded-b-lg" type="text" name="Dni" value="<?= $editando ? $servicioEditar['Dni'] : "" ?>" required></label>
