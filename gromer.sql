...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2025 a las 21:05:15
...
('96554730C', 'alba', 'Sánchez', 'Avellán', 'Calle Espinoso del Rey, 26', '625028777'),
...
('02334529C', 'admin@admin.es', '$2a$12$SMcRj5fWUnF2Brku6RSzWO4Xq7lFWJm9Toh1QdRdSmFdqyVo5EERW', 'ADMIN', 'Admin', 'Admin', 'Admin', NULL, NULL, NULL, NULL, NULL, '999999999', 'ADMIN'),
('05669743P', 'nutri@nutri.com', '$2a$12$D297VKXI4bEwPzEliYb6cuKYCmjOntcBCarAUe0J.v4j6gMF12Zlu', 'EMPLEADO', 'nutri', 'nutri', 'nutri', 'sdfghfd', 55, '45600', 'Talavera de la reina', 'Toledo', '987563214', 'NUTRICIONISTA'),
('34567890C', 'auxiliar@auxiliar.com', '$2y$10$X/29Ymp2ICy.Ex65XbTb..jywpVOV/DmfdrsXLrE3pzKnx/ZUWK.K', 'AUXILIAR', 'Pedro', 'Sánchez', 'Jimenez', 'Espinoso del rey', 90, '45600', 'Talavera de la Reina', 'Toledo', '111111111', 'AUXILIAR'),
('56789012A', 'esti@esti.com', '$2y$10$WTlIPQqbRfAv3ZxvYz7tZOKfDbpCx2T8AmkxiweQVjIeQi4CoS.ey', 'EMPLEADO', 'Juan', 'Alvarez', 'Gomez', 'Ramon y cajal', 39, '45600', 'Talavera de la Reina', 'Toledo', '222222222', 'ESTILISTA'),
('7777777Z', 'attcliente@attcliente.com', '$2y$10$qTJr3vr4.NdAbpXVQEuj9uGVExbcaZA9yoShvXDVQzUoFW6WMXh56', 'EMPLEADO', 'Óscar', 'Garcia', 'Perez', NULL, NULL, NULL, NULL, NULL, '333333333', 'ATT.CLIENTE');
...
(3, '12345678C', 'perrito', '1994-07-13', 'Pastor Alemán', 35.200, 65, 'Excelente guardián', '001-0001-00003', 'Macho'),
...
(64, '12345678A', 'alba', '2025-03-08', 'Bichon Maltes', 23.000, 56, 'nada', '19192', 'Macho');
...
(1, 'SVBE06', 3, '2024-02-15', 'Pelo enredado severamente, requiere seguimiento', 23.02, '56789012A'),
(2, 'SVBE09', 4, '2024-02-05', 'Tinte aplicado con éxito', 40.99, '56789012A'),
(3, 'SVBE10', 5, '2024-01-28', 'Terapia completada con buen resultado', 75.99, '56789012A'),
(4, 'SVNUT1', 6, '2024-01-22', 'Consulta inicial de nutrición con dieta personalizada', 30.00, '05669743P'),
(5, 'SVNUT2', 7, '2024-01-15', 'Sesión de relajación completa', 88.88, '05669743P'),
(6, 'SVBE04', 14, '2025-03-07', 'Sin problemas', 10.99, '56789012A'),
(7, 'SVNUT2', 9, '2025-02-28', 'Muchas', 21.00, '05669743P'),
(8, 'SVBE05', 10, '2025-03-07', 'Todas', 12.00, '56789012A'),
(9, 'SVBE08', 11, '2025-02-05', 'A', 12.00, '56789012A'),
(10, 'SVBE08', 12, '2025-02-12', 'Ninguna', 34.00, '56789012A'),
(11, 'SVBE06', 13, '2024-02-15', 'Pelo enredado severamente, requiere seguimiento', 23.02, '56789012A');
...
--
ALTER TABLE `perro_recibe_servicio`
  MODIFY `Sr_Cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
