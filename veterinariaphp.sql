...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-02-2025 a las 18:59:58
...
ALTER TABLE `perro_recibe_servicio`
  ...
  ADD CONSTRAINT `perro_recibe_servicio_ibfk_3` FOREIGN KEY (`ID_Perro`) REFERENCES `perros` (`ID_Perro`) ON DELETE CASCADE;
COMMIT;
